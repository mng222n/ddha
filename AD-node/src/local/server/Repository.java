...
public interface Repository
{
   ...
   /** Whether a user is present in the DHT overlay and can be used as key.
    * @param user the user name
    * @return true if the user name is present as key */
  public List<String> DHThasUser(String user);
  
  /** Adds a new user at the DHT overlay.
    * @param user the user name
    * @return this object */
  public int DHTaddUser(String user);
