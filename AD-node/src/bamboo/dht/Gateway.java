...
implements SingleThreadedEventHandlerIF {
    ...
    //                                                             //
    /////////////////////////////////////////////////////////////////
    //@skminh modify for xml-rpc inteface
    public class XmlRpcPutHandler {
        public void put (byte [] key_bytes, byte [] value, String ttl_sec1,
            ...
            int ttl_sec = Integer.parseInt(ttl_sec1);
    ...
    public class XmlRpcGetHandler {
        ...
        //private void get_common(byte [] key_bytes, String maxvals1, 
            ...
            // indicates to the Dht stage that it's okay to use the new sync
            // technique.
            //int maxvals = Integer.parseInt(maxvals1);
        ...
        public void get(byte [] key_bytes, String maxvals1, 
                        byte [] placemark_bytes, String application, 
                        String user_agent, InetSocketAddress client, 
